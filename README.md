...
└── game/                 # Game loop, Boss thread - I/O handling
```
...
### ML Integration
- [ ] NNUE evaluation (efficiently updatable neural net, replacing handcrafted eval)
- [ ] Policy network for move ordering (prioritize promising moves in search)
- [ ] Value network (deep neural net position evaluation, trained on Stockfish-labeled data)
